...
*/
  ...
  const MetaborgDistributionERC1155_V2 = await hre.ethers.getContractFactory(
    "MetaborgDistributionERC1155_V2"
  );
  const metaborgDistributionERC1155_V2 = await MetaborgDistributionERC1155_V2.deploy();

  await metaborgDistributionERC1155_V2.deployed();

  // await metaborgStars.initialize(IPFSList)
  console.log(
    "MetaborgDistributionERC1155_V2 deployed to:",
    metaborgDistributionERC1155_V2.address
  );

  smartContractList.push(metaborgDistributionERC1155_V2.address);
